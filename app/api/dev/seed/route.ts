...
const COURSES_DATA = [
  { code: 'COS40005', name: 'Computing Technology Project',    semester: 'Sem 1', year: 2026, capacity: 40, classType: 'LECTURE', classGroup: '01', scheduleDay: 'Tue', scheduleTime: '13:00 - 15:00', venue: 'G603' },
  { code: 'COS20019', name: 'Web Technology',                  semester: 'Sem 1', year: 2026, capacity: 60, classType: 'LECTURE', classGroup: '01', scheduleDay: 'Mon', scheduleTime: '09:00 - 11:00', venue: 'G501' },
  { code: 'COS30049', name: 'Computing Technology Innovation', semester: 'Sem 1', year: 2026, capacity: 50, classType: 'LECTURE', classGroup: '02', scheduleDay: 'Wed', scheduleTime: '11:00 - 13:00', venue: 'G602' },
];
...
export async function POST() {
  ...
  for (const c of COURSES_DATA) {
    const course = await prisma.course.upsert({
      where: { code: c.code },
      update: { lecturerId: lecturerProfile.id, name: c.name },
      create: { ...c, lecturerId: lecturerProfile.id },
    });
