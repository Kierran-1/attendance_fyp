...
function DetailCard({ label, value, icon: Icon }: DetailCardProps) {
  return (
    <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4 transition hover:border-rose-100 hover:bg-rose-50/40">
  ...
  if (status === 'loading' || loading) {
    return (
      <div className="flex min-h-[60vh] items-center justify-center">
        <div className="flex items-center gap-3 rounded-[1.75rem] border border-gray-100 bg-white px-5 py-4 text-sm font-medium text-gray-600 shadow-sm">
